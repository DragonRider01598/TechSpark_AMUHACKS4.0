  ...
  return (
    <div className="fixed inset-0 w-screen h-screen -z-10 bg-[#dff1c8bb]">
      ...
      <img
        ...
        alt="Pumpkin"
        className="absolute bottom-[58%] left-[2%] w-[120px] animate-bounce-slow opacity-55 "
      />
      <img
        src="/external/morango1955-a8t-300w.png"
        alt="Avocado"
        className="absolute bottom-[35%] left-[33%] w-[100px] animate-bounce-slow opacity-55"
      />
      <img
        src="/external/abacate1958-03ua-300h.png"
        alt="Strawberry"
        className="absolute bottom-[4%] left-[24%] w-[120px] animate-bounce-slow opacity-55"
      />
      <img
        src="/external/grape.svg"
        alt="Grape"
        className="absolute bottom-[58%] right-[1%] w-[120px] animate-bounce-slow opacity-55" 
      />
      <img
        src="/external/blueberry1954-1ub-300h.png"
        alt="Blueberry"
        className="absolute bottom-[25%] right-[42%] w-[100px] animate-bounce-slow opacity-55"
      />
      <img
        src="/external/image661957-6xhu-400h.png"
        alt="Onion"
        className="absolute bottom-[60%] right-[34%] w-[100px] animate-bounce-slow opacity-55"
      />
    </div>
  );
};

export default Background_main;
